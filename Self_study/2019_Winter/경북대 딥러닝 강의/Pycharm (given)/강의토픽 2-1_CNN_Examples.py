...
x_train = np.reshape(x_train[0:100],[-1, image_size, image_size, 1])
x_test = np.reshape(x_test[0:100],[-1, image_size, image_size, 1])
...
model.compile(loss='categorical_crossentropy',
              ...
              metrics=['accuracy'])
model.summary()
#plot_model(model, to_file="%s.png" % model_type, show_shapes=True)  #에러 발생함
#print(model_type)
...
img_path = 'D:/Data/African_Bush_Elephant.jpg'
...
#Predicted: [('n02504458', 'African_elephant', 0.8857345), ('n01871265', 'tusker', 0.06771097), ('n02504013', 'Indian_elephant', 0.036945257)]


"""
참고교재: Strengthening Deep Neural Networks

예제 2-1-5. Pretrained ResNet50 classification on the CIFAR10 dataset  
  
http://localhost:8888/notebooks/Desktop/강의관련/strengthening-dnns-master/chapter04/resnet50_classifier.ipynb
"""
